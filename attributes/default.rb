...
default['authconfig']['ldap']['debug'] = false
default['authconfig']['ldap']['debug_level'] = 4
...
default['authconfig']['ldap']['dns']['srv'] = false
default['authconfig']['ldap']['dns']['domain'] = 'domain1'
...
default['authconfig']['sssd']['ssh'] = false
default['authconfig']['ipa']['enable'] = false
default['authconfig']['ipa']['attribute'] = 'ipaSshPubKey'
